...
function Calendar({
  ...
  const defaultClassNames = {
    ...
    dropdown: "rounded-md border border-border bg-popover px-2 py-1 text-sm font-medium text-foreground outline-none focus:ring-2 focus:ring-ring/40 [&>option]:bg-popover [&>option]:text-foreground",
